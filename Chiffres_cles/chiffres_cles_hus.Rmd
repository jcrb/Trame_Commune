...
Chiffres Clés Hôpitaux Universitaires de Strasbourg en `r anc`
================================
...
n.rpu.anp <- n.rpu.2013.hus
n.sae <- passages.2014.SAE.hus

dx <- dx[dx$FINESS %in% c("Hus", "HTP", "NHC"),]
...
t <- table(merge2015$CODE_URGENCE[merge2015$FINESS %in% c("Hus", "HTP", "NHC")])
sum <- sum(t)
...
# correction pour tenir compte de HTP et NHC
rpu$Hus <- rpu$Hus + rpu$HTP + rpu$NHC
