---
title: "Chiffres clés - Clinique Ste Anne"
author: "RESURAL"
date: "27 août 2015"
output:
...
Chiffres Clés de la clinique Sainte Anne en `r anc`
================================
```{r date, echo=FALSE}
# à adapter:
hop <- "Ane"
titre <- "Clinique Sainte Anne"

n.rpu.anp <- rpu[hop, paste0("X",anp)] # n.rpu.2013.hag
n.sae <- sae[hop, paste0("X",anc)] # passages.2014.SAE.hag
...
-----------------------
```{r hag_completude, echo=FALSE, fig.width= 8}
...
rpu <- read.csv(paste("../../../Stat Resural/RPU_2014/rpu_jour_", anc, ".csv"))
colnames(rpu)[1] <- "date"
colnames(rpu)[2] <- "3Fr"
