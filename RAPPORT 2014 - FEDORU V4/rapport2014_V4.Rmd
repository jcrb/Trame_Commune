...
- %(N) d'évolution par rapport à année N-1: __`r round(evolution(n.rpu, n.rpu.2013)*100, 0)` %__.
...
- %(N) Femme: `r round(p.femme, 2)` % (`r format.n(sexe['F'])`)
- %(N) Homme: `r round(p.homme, 2)` % (`r format.n(sexe['M'])`)
...
- age moyen des hommes: `r round(mean.age.sexe['M'], 2)` ans.
- age moyen des femmes: `r round(mean.age.sexe['F'], 2)` ans.
...
Part des non résidents: __`r (1 - p.org_als) * 100`%__ (N = `r n.rpu - n.org_als`)
...
- % passages nuit (20h - 8h): __`r round(p.passages.nuit * 100, 2)` %__ (N = `r format.n(n.passages.nuit)`)
- % passages nuit profonde: __`r round(p.passages.nuit.profonde * 100, 2)` %__ (N = `r format.n(n.passages.nuit.profonde)`)
...
- %  passages en horaire de PDS: __`r p.pds * 100` %__ [N = `r format.n(n.pds)`](Remarque: ne tient pas compte des jours fériés survenant en semaine)
...
- __%(N) d'arrivée personnel__: `r round(n.transport.perso * 100 / n.transport, 2)` % (N = `r format.n(n.transport.perso)`)
- __%(N) d'arrivée SMUR__: `r round(n.transport.smur * 100 / n.transport, 2)` % (N = `r format.n(n.transport.smur)`)
- __%(N) d'arrivée VSAB__: `r round(n.transport.vsab * 100 / n.transport, 2)` % (N = `r format.n(n.transport.vsab)`)
- __%(N) d'arrivée Ambulance__: `r round(n.transport.ambu * 100 / n.transport, 2)` % (N = `r format.n(n.transport.ambu)`)
...
- __%(N) CCMU 1 __: `r round(100 * p.ccmu1, 2)`% (n = `r format.n(n.ccmu1)`)
- __%(N) CCMU 1 et 2__: `r round(100 * p.ccmu12, 2)`% (n = `r format.n(n.ccmu12)`)
- __%(N) CCMU 4 et 5__: `r round(100 * p.ccmu45, 2)`% (n = `r format.n(n.ccmu45)`)
...
- %  Médico-chirurgical: __`r format.n(136816)`__
- %  Traumatologique: __`r format.n(91907)`__
- %  Psychiatrique: __`r format.n(6185)`__
- %  Toxicologique: __`r format.n(4847)`__
- %  Autres recours: __`r format.n(7441)`__
...
- durée moyenne de passage __`r mean.duree` mn__.
- écart-type: `r sd.duree` mn.
- médiane: __`r median.duree` mn__.
...
colnames(t) <- c("CHU", "SU non CHU siège de SAMU","SU non SAMU siège de SMUR","Autre SU")
