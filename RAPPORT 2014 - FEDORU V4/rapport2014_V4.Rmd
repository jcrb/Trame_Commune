...
n.pds <- p.s.pds["PDSS"] + p.s.pds["PDSWE"] # nombre de passages aux haoraires de PDS

#---------------------- Chiffres ---------------------------------------------------------------
#---------------------- Chiffres ---------------------------------------------------------------
```

- %  passages en horaire de PDS: `r n.pds * 100` % (Remarque: ne tient pas compte des jours fériés survenant en semaine)
...
```{r star_orientation, echo=FALSE, results='asis'}
