...
En `r anc`, l'Alsace recense `r format.n(155281)` personne de 75 ans ou plus.
...
- Taux de recours aux SU de la population gériatrique: `r round(n.rpu75*100/155281, 2)` %
...
- % réponses manquantes: `r round(s["p.na"]*100, 2)`
...
- Nombre d'âges renseignés: `r format.n(age['n.rens'])`
        ...
        - moins d'un an: `r format.n(age['n.inf1an'])`
        - moins de 15 ans: `r format.n(a['n.inf15ans'])`
...
```{r}
# données 2013
load("~/Documents/Resural/Stat Resural/RPU_2013/rpu2013d0112_2.Rda")
t <- table(d1$FINESS)
