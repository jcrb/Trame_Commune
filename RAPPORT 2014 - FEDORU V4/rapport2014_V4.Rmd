...
```{r, echo=FALSE, results='asis'}
    ...
    print.summary.rpu(a, cnames = c("Tranches d'âge","n", "%"), rnames = c("Moins de 1 an", "Moins de 15 ans", "75 ans et plus"), caption = "Nombre de RPU par tranches d'âge")
```
...
- Moyen de transport utilisé pour se rendre aux urgences:
```{r, echo=FALSE, results='asis'}
print.table.rpu(transport, caption = "Moyens de transport")
```
