...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{es <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{es <-}\StringTok{ }\NormalTok{dx[dx$FINESS  %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Ane"}\NormalTok{,}\StringTok{"Odi"}\NormalTok{,}\StringTok{"Dts"}\NormalTok{,}\StringTok{"Geb"}\NormalTok{,}\StringTok{"Alk"}\NormalTok{,}\StringTok{"3Fr"}\NormalTok{,}\StringTok{"Ros"}\NormalTok{,}\StringTok{"Dia"}\NormalTok{),]}
