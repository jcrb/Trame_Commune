...
Part des non résidents: __`r (1 - p.org_als) * 100`%__ (N = format.n(`r n.rpu - n.org_als`))
...
# par tranche d'age de 5 ans, borne sup exclue: [0-5[ ans
p <- pyramide.age(pop75, cut = 1, gap = 0.3,cex = 0.6)
```
...
- Nombre de passages déclarés: `r format.n(a['n.passages'])` en `r anc`.
- Nombre de RPU avec un âge renseigné: `r format.n(a['n.age.ren'])`.
- Nombre de RPU avec un code postal renseigné: `r format.n(a['n.cp.rens'])`.
- Nombre de passages par jour de la semaine:
        - Lundi: `r format.n(a['n.lun'])`
        - Mardi: `r format.n(a['n.mar'])`
        - Mercredi: `r format.n(a['n.mer'])`
        - Jeudi: `r format.n(a['n.jeu'])`
        - Vendredi: `r format.n(a['n.ven'])`
        - Samedi: `r format.n(a['n.sam'])`
        - Dimanche: `r format.n(a['n.dim'])`
- Nombre d'âges renseignés: `r format.n(a['n.age.rens'])`
        - moins d'un an: `r format.n(a['n.inf1an'])`
        - moins de 15 ans: `r format.n(a['n.inf.15ans'])`
        - 75 ans et plus: `r format.n(a['n.75ans'])`
